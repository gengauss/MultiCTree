...
from trainer_multiCTree import trainer_bonescinti
...
if __name__ == "__main__":
    ...
    snapshot_path = "./models/{}fold/finetune/".format(args.fold)
    ...
    net.load_state_dict(torch.load("./models/{}fold/pretrain/epoch_4.pth".format(args.fold)))
    ...
    trainer = {'TransBtrflyNet': trainer_bonescinti,}
