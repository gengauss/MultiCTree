    ...
    def forward(self, x):
        ...
        for i in range(len(self.body)-1):
            ...
            if x.size()[2] != right_size_h or x.size()[3] != right_size_w:
                pad_h = right_size_h - x.size()[2]
                pad_w = right_size_w - x.size()[3]
                assert pad_h < 3 and pad_h > 0, "x {} should {}".format(x.size(), right_size_h)
                assert pad_w < 3 and pad_w > 0, "x {} should {}".format(x.size(), right_size_w)
